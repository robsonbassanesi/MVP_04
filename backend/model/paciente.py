...
class Paciente(Base):
    ...
    radius_mean_column = Column("radius_mean", Float)
    texture_mean_column = Column("texture_mean", Float)
    perimeter_mean_column = Column("perimeter_mean", Float)
    area_mean_column = Column("area_mean", Float)
    smoothness_mean_column = Column("smoothness_mean", Float)
    compactness_mean_column = Column("compactness_mean", Float)
    concavity_mean_column = Column("concavity_mean", Float)
    concave_points_mean_column = Column("concave_points_mean", Float)
    symmetry_mean_column = Column("symmetry_mean", Float)
    fractal_dimension_mean_column = Column("fractal_dimension_mean", Float)
    radius_se_column = Column("radius_se", Float)
    texture_se_column = Column("texture_se", Float)
    perimeter_se_column = Column("perimeter_se", Float)
    area_se_column = Column("area_se", Float)
    smoothness_se_column = Column("smoothness_se", Float)
    compactness_se_column = Column("compactness_se", Float)
    concavity_se_column = Column("concavity_se", Float)
    concave_points_se_column = Column("concave_points_se", Float)
    symmetry_se_column = Column("symmetry_se", Float)
    fractal_dimension_se_column = Column("fractal_dimension_se", Float)
    radius_worst_column = Column("radius_worst", Float)
    texture_worst_column = Column("texture_worst", Float)
    perimeter_worst_column = Column("perimeter_worst", Float)
    area_worst_column = Column("area_worst", Float)
    smoothness_worst_column = Column("smoothness_worst", Float)
    compactness_worst_column = Column("compactness_worst", Float)
    concavity_worst_column = Column("concavity_worst", Float)
    concave_points_worst_column = Column("concave_points_worst", Float)
    symmetry_worst_column = Column("symmetry_worst", Float)
    fractal_dimension_worst_column = Column("fractal_dimension_worst", Float)
